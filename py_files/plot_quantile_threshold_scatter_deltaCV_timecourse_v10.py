...
1) scatterplot of pre_cv vs post_cv, each point = one syllable (legend bottom-right with framed swatch-style color key; scatter x/y labels, ticks, and legend at fontsize 16)
