...
def plot_clean_timecourse_panels(
    ...
    *,
    ...
    if compact_for_figure_panel:
        # Keep the legend inside the top panel so the exported image can fill
        # the full width of an Illustrator artboard without a large right margin.
        axes[0].legend(handles=handles, frameon=False, fontsize=7.5, loc="upper right")
        top_rect = 0.915 if title else 0.97
