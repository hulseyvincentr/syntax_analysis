...
def plot_pre_post_distribution_boxplot(
    ...
    *,
    ...
    ax.legend(handles=handles, frameon=False, fontsize=11, loc="best")
...
def _build_arg_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        description=(
            "Make Panel C pre/post scatterplots, boxplots, statistics, plus Panel D variance-over-days "
            "plots using one colorblind-friendlier lesion-group palette."
        )
    )
