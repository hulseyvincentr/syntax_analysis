...
def make_boxplots_only(
    ...
    *,
    ...
    y_label: str = "Bhattacharyya coefficient\n(early vs. late, each equal sample size)",
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--y-label", default="Bhattacharyya coefficient\n(early vs. late, each equal sample size)", type=str)
