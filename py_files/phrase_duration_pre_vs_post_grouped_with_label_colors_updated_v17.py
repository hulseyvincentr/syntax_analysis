...
def _build_arg_parser():
    ...
    p.add_argument("--figure-height-cm", dest="figure_height_cm", type=float, default=3.2,
                   help="Height of each combined 1x3 bird strip in centimeters.")
    p.add_argument("--save-pad-inches", dest="save_pad_inches", type=float, default=0.02,
