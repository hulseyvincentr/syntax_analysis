...
SCRIPT_VERSION = "equal_umap_cluster_spectrograms_v8_run_balanced_phrase_normalized"
...
def export_equal_umap_cluster_spectrograms_for_one_bird(
    *,
    ...
    if str(bc_analysis_mode) == "run_balanced_phrase_normalized":
        ...
        print("[INFO] UMAP/BC uses frame-weighted equal selected time bins, matching the older behavior.")
