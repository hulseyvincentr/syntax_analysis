...
def plot_panel_d_sd_timecourse_overlay(
    ...
    *,
    ...
    ax.set_ylabel(y_label, fontsize=axis_label_fontsize, labelpad=6)
    ...
    ax.legend(handles=handles, frameon=False, fontsize=legend_fontsize, loc="upper left", bbox_to_anchor=(1.01, 1.0), borderaxespad=0.0)
...
def make_panel_c_and_d_variance_plots(
    *,
    ...
    if daily_csv is not None:
        ...
        overlay_size = (timecourse_fig_width, max(4.8, timecourse_fig_height * 0.56))
