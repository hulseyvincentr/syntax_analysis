...
# -*- coding: utf-8 -*-
"""
figure3_panelE_longevity_normalized_sd_cv_v1.py
...
def plot_timecourse(
    ...
    *,
    ...
    handles = [
        Line2D([0], [0], color=ML_INDIVIDUAL_COLOR, alpha=min(0.65, raw_alpha * 3), linewidth=1.0, marker="o", markersize=3, label="individual M+L birds"),
