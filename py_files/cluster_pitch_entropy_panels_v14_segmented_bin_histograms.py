#!/usr/bin/env python3
"""
cluster_pitch_entropy_panels_v14_segmented_bin_histograms.py
...
5) optional pitch-contour FFT segmentation CSVs, visual segmentation guides, segmented-syllable QC figures, and segmented-bin histograms
Assumptions:
- NPZ contains:
