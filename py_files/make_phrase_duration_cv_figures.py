...
def make_stats(animal: pd.DataFrame, args: argparse.Namespace) -> tuple[pd.DataFrame, pd.DataFrame]:
    ...
    # Use two-sided between-group comparisons by default unless requested otherwise.
...
def main() -> None:
    ...
    ap.add_argument("--between-alternative", choices=["greater", "less", "two-sided"], default="two-sided",
                    help="Between-group label-shuffle alternative for pairwise ΔCV comparisons.")
