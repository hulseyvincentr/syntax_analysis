...
# -*- coding: utf-8 -*-
"""
figure3_panelE_longevity_normalized_sd_cv_v3.py
...
Updates in v3
-------------
1. Long y-axis labels are split across two lines so they no longer get cut
   off in exported figures.
2. Symlog percent-change plots now use a sparse set of major ticks centered on
   zero for easier reading.
3. The plain-number log tick labels and summary-only timecourse versions from
   v2 are retained.
