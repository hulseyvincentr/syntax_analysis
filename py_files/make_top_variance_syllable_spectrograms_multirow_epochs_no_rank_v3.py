...
SCRIPT_VERSION = "multirow_epochs_no_rank_filenames_v2"
    ...
    *,
    ...
    for animal_id, bird_df in top_df.groupby("animal_id", sort=True):
        ...
        for _, row in bird_df.iterrows():
            ...
            # Use zero-padded label IDs in filenames, e.g. label03 instead of label3.
            # Deliberately omit phrase-variance rank prefixes from filenames.
            label_token = f"label{int(label):02d}"
