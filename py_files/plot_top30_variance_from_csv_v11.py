...
# -*- coding: utf-8 -*-
"""
plot_top30_variance_from_csv_v11.py
...
LEGEND_LABEL_MAP = {
    ...
    "lateral hit only": "Area X visible (Lateral only)",
...
def plot_panels(
    ...
    *,
    ...
    fig.supylabel(
        "Variance of Phrase Duration (ms²)" if not split_y_label_lines else _ylabel_text(True),
...
def save_large_legend_png(
    ...
    *,
    ...
    legend = ax.legend(
        ...
        labelspacing=0.7,
        fancybox=False,
        edgecolor="0.4" if frameon else None,
    )
    if frameon and legend.get_frame() is not None:
        legend.get_frame().set_linestyle((0, (2, 2)))
...
def make_top30_plots_from_csv(
    ...
    *,
    ...
    panels_no_titles_path = out_dir / "batch_aligned_phrase_duration_variance_top30_by_lesion_type_panels_no_titles.png"
