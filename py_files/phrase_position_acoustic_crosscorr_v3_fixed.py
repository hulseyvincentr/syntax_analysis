#!/usr/bin/env python3
"""
phrase_position_acoustic_crosscorr_v3_fixed.py

Analyze whether acoustic structure changes as a repeated syllable phrase progresses.

Version 3 fixes constant-x regression crashes and adds the missing --max-plot-previous-repeats parser option.
...
def main():
    ...
    parser.add_argument("--max-plot-previous-repeats", type=int, default=None,
                        help="Optional x-axis maximum for previous-repeat plots. If omitted, plot all repeats.")
