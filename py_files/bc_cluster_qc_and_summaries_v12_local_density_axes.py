...
SCRIPT_VERSION = "bc_cluster_qc_and_summaries_v12_local_density_axes"
DEFAULT_V8_SCRIPT = "/mnt/data/export_equal_umap_cluster_spectrograms_v12_local_density_axes.py"
...
def _compute_cluster_bcs(
    *,
    ...
    # Match the per-cluster UMAP density plots: define the density grid from
    # the selected points for this cluster, not the full whole-bird UMAP extent.
    all_idx = np.concatenate([ep, lp, eo, lo])
    sx = xy[all_idx, 0]
    sy = xy[all_idx, 1]
