#!/usr/bin/env python3
"""
cluster_pitch_entropy_panels_v19_canary_skip_edges_prepost_overlay.py
...
5) optional pitch-contour FFT segmentation CSVs, visual segmentation guides, segmented-syllable QC figures, zoomed segmented-bin histograms with statistics, and overlaid density plots
Assumptions:
- NPZ contains:
