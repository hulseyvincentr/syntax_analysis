...
def plot_change_metric_boxplot_vs_sham(
    ...
    *,
    ...
    delta_ylabel_fontsize = max(axis_label_fontsize - 1.5, 12)
    ax.set_ylabel(y_label, fontsize=delta_ylabel_fontsize, labelpad=8)
    ...
    fig.subplots_adjust(left=0.23, right=0.99, bottom=0.48, top=0.88)
    fig.savefig(out_path, dpi=dpi, bbox_inches="tight", pad_inches=0.12)
    if show:
        plt.show()
    else:
