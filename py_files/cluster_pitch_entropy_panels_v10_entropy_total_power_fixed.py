#!/usr/bin/env python3
"""
cluster_pitch_entropy_panels_v10_entropy_total_power_fixed.py
    ...
    for row_idx, seg_list in enumerate(row_segments):
        ...
        if row_idx == 0:
            spec_ax.set_title(
                ...
                f"Spectrograms shown without overlays; feature panels below show pitch, pitch derivative, Wiener entropy, and total power. Gaps = NaN.",
                fontsize=13
            )
