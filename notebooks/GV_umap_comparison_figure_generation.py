#Adjust the bottom of the code to contain the path to the .npz file you want to run, as well as the path to the file you want to 
#save the output graphs to.
...
if __name__ == "__main__":
    # test on two birds
    npz_files = ["/Users/mirandahulsey-vincent/Documents/allPythonCode/syntax_analysis/data_inputs/Area_X_lesions_balanced_training_data/balanced_dataset_npz_files/USA5325.npz"]
    save_dir = "/Users/mirandahulsey-vincent/Documents/allPythonCode/syntax_analysis/data_inputs/Area_X_lesions_balanced_training_data/balanced_dataset_npz_files/"
